...
The precise structure should be discussed with your supervisor, but some suggestions for additional sections are given below. The key thing to note here is that irrespective of the project type, you should justify the choices you have made, rather than simply choosing based on expediency or familiarity.
...
Again, this list is not exhaustive, and you should still include relevant sections pertaining to the software artefact listed in the section above.
...
- Statistical analysis (i.e., how you will analyse the raw data)
